...
DROP TABLE IF EXISTS `userorderproduct`;
...
CREATE TABLE `userorderproduct` (
  ...
  CONSTRAINT `fk_User_has_Product_Product1` FOREIGN KEY (`productId`) REFERENCES `product` (`productId`),
...
LOCK TABLES `userorderproduct` WRITE;
/*!40000 ALTER TABLE `userorderproduct` DISABLE KEYS */;
/*!40000 ALTER TABLE `userorderproduct` ENABLE KEYS */;
UNLOCK TABLES;
