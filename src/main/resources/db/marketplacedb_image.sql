...
CREATE TABLE `image` (
  ...
  `imageUrl` varchar(510) DEFAULT NULL,
  `imageDesc` varchar(45) DEFAULT NULL,
  `Product_idProduct` int NOT NULL,
  PRIMARY KEY (`imageId`),
  UNIQUE KEY `imageId_UNIQUE` (`imageId`),
  KEY `fk_Image_Product1_idx` (`Product_idProduct`),
  CONSTRAINT `fk_Image_Product1` FOREIGN KEY (`Product_idProduct`) REFERENCES `product` (`productId`)
...
INSERT INTO `image` VALUES (1,'https://facebook.com','facebook icons',1);
